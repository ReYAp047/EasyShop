...
public class orderManagment extends javax.swing.JFrame {
     ...
     */
    public orderManagment() throws ClassNotFoundException, SQLException {
         initComponents();
        table_update();
    }
    ...
    static int idC;
            ...
            ResultSet rs = OrderManagmentt.allCommand();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id Commande", "Commande Date", "Total Price", "State"
            }
        ) {
...
if(selectedIndex == -1)
           JOptionPane.showMessageDialog(this,"Aucune Commande séléctionner!");
else{
     DefaultTableModel df =(DefaultTableModel)jTable1.getModel();
        
        String idS = (String) df.getValueAt(selectedIndex, 0);
        idC=Integer.parseInt(idS);
                 orderProducts si = new orderProducts();
            si.setVisible(true);
}
    ...
    private void jLabel29MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel29MouseClicked
        ...
        if(selectedIndex == -1){
            ...
            int dialogResult = JOptionPane.showConfirmDialog(null, "Vous voulez confirmer cette Commande? ", "Warning", JOptionPane.YES_NO_OPTION);
        ...
        idC=Integer.parseInt(idS);
                try {
                    OrderManagmentt.CommandAccept(idC);
                    JOptionPane.showMessageDialog(this,"Commande Accepter!");
        ...
        idC=Integer.parseInt(idS);
                try {
                    OrderManagmentt.CommandDecline(idC);
                    JOptionPane.showMessageDialog(this,"Commande Refuser!");
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(orderManagment.class.getName()).log(Level.SEVERE, null, ex);
                } catch (SQLException ex) {
                    Logger.getLogger(orderManagment.class.getName()).log(Level.SEVERE, null, ex);
